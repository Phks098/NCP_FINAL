...
<%
Admin_Set_DAO dao1 = new Admin_Set_DAO();
ArrayList<Professor_weight_VO> weight = dao1.getAll_Professor_weight_VO(); // 전체 가중치를 가져온다	
ArrayList<Matching_criteria_VO> match = dao1.getAll_Matching_criteria_VO(); // 전체 매칭 비율을 가져온다
ArrayList<Diagnosis_criteria_VO> level = dao1.getAll_Diagnosis_criteria_VO(); // 전체 준비 수준을 가져온다
	...
	<main class="main_contents">
		<div class="contents">
			<section class="nav-contents">
				...
				<div class="info_text_area">
						...
						<h3 class="info_text">교수평가 가중치 설정</h3>
					</div>
				<!-- 가중치설정 테이블 시작-->
				<div class="weight_set_Table">
					<form action="/Project_NCP/Admin_Set_Servlet?action=weightSet"
						method="post">
						<table>
				...
				<form action="/Project_NCP/Admin_Set_Servlet?action=matchSet"
					method="post">
					<div class="info_text_area">
						<img
							src="https://semsplus.seowon.ac.kr/contents/images/client/sub/icon_tit_lg.png" />
		...
		+ match.get(45).getMatching_rate() + match.get(46).getMatching_rate() + match.get(47).getMatching_rate())%>%</td>
				...
				<div class="info_text_area">
					<img
						src="https://semsplus.seowon.ac.kr/contents/images/client/sub/icon_tit_lg.png" />
					<h3 class="info_text">준비수준 설정</h3>
				</div>
				
				<div class="Digrage">
					<form action="/Project_NCP/Admin_Set_Servlet?action=setLevel" method="post">
					<div class="match tbl_fixed match_row">
						<table>
							<tbody>
								<tr>
