...
function createList(accordion, data){
	...
	gotoStudentInformation.setAttribute("href", "Mypage_Servlet?student=" + data['university_number']);
	...
	gotoIdentity.setAttribute("href", "Mypage_Servlet?student=" + data['university_number']);
