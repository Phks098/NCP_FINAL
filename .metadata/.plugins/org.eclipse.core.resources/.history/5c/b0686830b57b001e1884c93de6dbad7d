...
@WebServlet("/Admin_Set_Servlet")
public class Admin_Set_Servlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       

    public Admin_Set_Servlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String nextPage = "AdmimPrototype.jsp";
		...
		if (action == null) {
			...
			String[] setLevel = request.getParameterValues("setLevel");
			dao.Update_Leve(setLevel);
		}
